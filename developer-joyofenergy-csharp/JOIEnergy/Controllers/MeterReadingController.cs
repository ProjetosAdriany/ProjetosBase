...
namespace JOIEnergy.Controllers
{
    ...
    public class MeterReadingController : Controller
    {
        ...
        [HttpGet("readLastweek/{smartMeterId}")]
        public ObjectResult GetReadingLastWeek(string smartMeterId)
        {
            try
            {
                return new OkObjectResult(_meterReadingService.GetReadingsLastWeek(smartMeterId));
            }
            catch(Exception e)
            {
                return new BadRequestObjectResult("Internal Server Error");
